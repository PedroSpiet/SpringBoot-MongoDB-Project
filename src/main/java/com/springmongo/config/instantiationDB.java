...
public class instantiationDB implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Posts p1 = new Posts(null, sdf.parse("20/01/2021"), "Partiu Viagem", "Vou viajar para SP!", user1);
		Posts p2 = new Posts(null, sdf.parse("20/01/2021"), "Bom dia", "Acordei feliz!", user1);
